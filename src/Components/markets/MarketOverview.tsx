...
import Chart_section from '../Chart/Chart_section'


export default function MarketOverview() {
  const {data:globals} = UseGlobal()
  return (
    <div className='flex flex-col w-[1500px] min-h-[100px] shadow-2xl bg-amber-500 shadow-gray-600  rounded-2xl p-2 justify-center mt-10 items-center mr-auto ml-auto gap-5'>
