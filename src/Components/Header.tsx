 ...
 const [mounted, setMounted] = React.useState(false);
  ...
  <div className="max-w-7xl mx-auto flex items-center justify-between px-6 py-4">
    ...
    <nav className="hidden lg:flex items-center justify-center gap-8 text-gray-800 dark:text-gray-100 font-medium whitespace-nowrap">
      ...
      <Link href="/markets" className="hover:text-blue-500 transition-colors">Markets</Link>
      <Link href="/coins" className="hover:text-blue-500 transition-colors">Coins</Link>
      <Link href="/news" className="hover:text-blue-500 transition-colors">News</Link>
      <Link href="/nfts" className="hover:text-blue-500 transition-colors">NFTs</Link>
    ...
    <div className="flex items-center gap-6 shrink-0">
      ...
      <label className="flex items-center cursor-pointer">
        <div className="relative">
          ...
          <div className={`absolute left-1 top-1 w-6 h-6 bg-white dark:bg-gray-900 rounded-full transition-transform duration-500 ease-in-out ${
      ...
      <div className="flex border border-gray-300 rounded-xl overflow-hidden shadow-md">
        <Link href="/login" className="px-4 py-2 text-gray-800 dark:text-gray-200 hover:bg-gray-100 dark:hover:bg-gray-800 transition-colors font-medium">
          Login
        </Link>
        <Link href="/signup" className="px-4 py-2 text-gray-800 dark:text-gray-200 hover:bg-gray-100 dark:hover:bg-gray-800 transition-colors font-medium border-l border-gray-300">
          Sign Up
        </Link>
      </div>
    </div>
