...
export default function Contact_US() {
  ...
  const handeles = async (e: { preventDefault: () => void }) => {
    e.preventDefault();
    const res = await axios("/api/users/contact-us", {
      method: "POST",
      headers: {
    ...
    setData({ firstname: "", lastname: "", gmail: "", message: "" });
  };
        ...
        <div className="flex flex-col md:flex-row justify-center mr-auto ml-auto items-center border-[3px] border-white shadow-xl shadow-gray-400 w-full max-w-6xl min-h-[650px] rounded-2xl overflow-hidden">
          <div className="left w-full md:w-1/3 bg-blue-900 p-6 rounded-2xl">
            ...
            <div className="flex items-center mt-4">
              <span className="text-2xl md:text-4xl font-bold text-white ml-2">
                Iran
              </span>
            </div>
          ...
          <div className="right w-full md:w-2/3  md:ml-8 shadow-xl p-8">
            <form onSubmit={handeles}>
              ...
              <div className="flex flex-col mt-6">
                ...
                <label
                  htmlFor="message"
                  className="mb-3 mt-4 text-xl text-cyan-300 font-bold"
                >
                  Your message:
                </label>
                <textarea
